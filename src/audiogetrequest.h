...
#ifndef QTVK_AUDIOGETREQUEST_H
#define QTVK_AUDIOGETREQUEST_H

#include "audiolistrequest.h"

namespace QtVk
{
  
  class QTVK_EXPORT AudioGetRequest : public AudioListRequest
  {
    Q_OBJECT
  ...
  public:
     ...
     **/
    explicit AudioGetRequest(int oid = 0, int album = 0, int count = 0, int offset = 0, bool needUser = false, QObject *parent = 0);
    /**
     * @brief Null constructor.
     *
     * @param parent QObject parent.
     **/
    explicit AudioGetRequest(QObject* parent);
  ...
  private:
    struct AudioGetRequestPrivate;
    AudioGetRequestPrivate *d;
  };

}

#endif // QTVK_AUDIOGETREQUEST_H
